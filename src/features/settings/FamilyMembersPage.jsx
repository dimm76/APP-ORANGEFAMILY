...
export default function FamilyMembersPage() {
  ...
  return <div className="od-page"><div className="od-page-inner od-page-inner--full od-page-inner--align-stretch">
    <div className="od-page-header"><div><h1 className="od-page-title">Ajustes · Familiares</h1><p className="od-page-subtitle">Los familiares con acceso pueden utilizar OrangePhotos.</p></div><button type="button" className="od-button-secondary of-family-add-button" onClick={openCreate}>+ Añadir familiar</button></div>
