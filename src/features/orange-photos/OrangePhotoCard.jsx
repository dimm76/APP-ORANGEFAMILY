...
export default function OrangePhotoCard({ photo, selected, onSelect, onOpen, eager = false }) {
  ...
  const duration = Number(photo.duration_seconds), showDuration = Number.isFinite(duration) && duration > 0;
