...
const ownedAccessSql=(alias="p")=>`${alias}.owner_user_id=$2::uuid`;const libraryMembershipSql=(alias="p")=>`EXISTS(SELECT 1 FROM public.orange_photo_library_items library_item WHERE library_item.photo_id=${alias}.id AND library_item.user_id=$2::uuid)`;
