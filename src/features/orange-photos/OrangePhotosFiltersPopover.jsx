...
export default function OrangePhotosFiltersPopover({ open, anchorRef, filters, emptyFilters, onClose, onApply, members = [], membersLoading = false, allowedAccessSources, centered = false, showIntegratedInLibraryOption = false }) {
  ...
  const content = <OrangePhotosFiltersBar filters={draft} members={members} membersLoading={membersLoading} allowedAccessSources={allowedAccessSources} showIntegratedInLibraryOption={showIntegratedInLibraryOption} onChange={setDraft} />;
