...
import { albumsOutline, arrowBackOutline, imagesOutline } from "ionicons/icons";
...
export default function OrangePhotosSidebar({ pathname, onNavigate }) {
  const items = [
    ...
    { label: "Álbumes", href: "/app/orangephotos/albums", icon: albumsOutline, active: pathname.startsWith("/app/orangephotos/albums") },
  ];
