...
export default function OrangePhotosFiltersPopover({ open, anchorRef, filters, emptyFilters, onClose, onApply, members = [], membersLoading = false, allowedAccessSources, centered = false, showIntegratedInLibraryOption = false, showHiddenOption = false }) {
  ...
  const content = <OrangePhotosFiltersBar filters={draft} members={members} membersLoading={membersLoading} allowedAccessSources={allowedAccessSources} showIntegratedInLibraryOption={showIntegratedInLibraryOption} showHiddenOption={showHiddenOption} panelPortal={!centered} onChange={setDraft} />;
